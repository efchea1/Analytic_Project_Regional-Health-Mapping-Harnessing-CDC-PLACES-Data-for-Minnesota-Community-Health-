            ...
            fluidRow(
              column(
                ...
                box(
                  ...
                  plotOutput("plot_state", height = "400px"), # State plot output
              ...
              column(
                ...
                box(
                  ...
                  collapsible = TRUE,
                  width = NULL,
                  plotOutput("plot_chbRegion", height = "400px"), # Region plot output
            ...
            fluidRow(
              column(
                ...
                box(
                  ...
                  collapsible = TRUE,
                  width = NULL,
                  plotOutput("plot_chdCHB", height = "400px"), # CHB plot output
              ...
              column(
                ...
                box(
                  ...
                  collapsible = TRUE,
                  width = NULL,
                  plotOutput("plot_confidenceInterval", height = "400px"), # County plot output
